...
use super::{Cell, City, Vehicle, Traffic};
...
impl Render for Vehicle {
    ...
    fn render(&self, graphics: &mut GlGraphics, context: &Context) {
        ...
        let square = rectangle::square(self.location.x as f64 * 2.0, self.location.y as f64 * 2.0, 2.0);
        rectangle(COLOURS[self.destination], square, context.transform, graphics);
    }
}
